<div class="memberships index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $membership['Membership']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $membership['Membership']['start_date']; ?>&nbsp;</td>
		<td><?php echo $membership['Membership']['end_date']; ?>&nbsp;</td>
		<td><?php echo $membership['Membership']['created']; ?>&nbsp;</td>
		<td><?php echo $membership['Membership']['modified']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $membership['Membership']['id'])); ?>
