...
<?php echo $this->Form->create('Institution');?>
	<fieldset>
 		<legend><?php __('Edit Institution'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Institution.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Institution.id'))); ?></li>
